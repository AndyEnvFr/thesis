...
with new DD function: amplitude
...
nddVar_options <- c(0.1, 0.01, 0.001, 0.0001) # c(0.3, 0.005)
pddVar_options <- c(0.1, 0.01, 0.001, 0.0001) # c(0.3, 0.005)
...
```{r}
runz <- runSimulationBatch(params, parallel = 25, backup_path = "~/cyber_synch/local/runs/mstr/backups/")
saveRDS(runz, paste0(root, "/local/runs/mstr/20250804/runs_i.rds"))
```
...
saveRDS(res, paste0(root, "local/runs/mstr/20250804/tab.rds"))
```
