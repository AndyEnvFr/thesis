...
tab <- readRDS(paste0(root, "local/runs/mstr/20250804/tab_i.rds"))
```
...
```{r}
# saveRDS(mcS_err_sim, paste0(root, "local/runs/mstr/20250804/metafor_interim/metafor.rds"))
...
saveRDS(pred, paste0(root, "local/runs/mstr/20250804/metafor_interim/pred.rds"))
...
group_patterns <- list(
  ndd0 = "ndd0$",
  pdd0 = "pdd0_",
  ndd1pdd1Var0.1 = c("ndd1", "pdd1Var0.1"),
  ndd1pdd1Var0.01 = c("ndd1", "pdd1Var0.01"),
  ndd1pdd1Var0.001 = c("ndd1", "pdd1Var0.001"),
  ndd1pdd1Var1e04 = c("ndd1", "pdd1Var1e-04")
)
...
pdf(paste0(root, "local/figures/mstr/20250804/metafor/abund.pdf"), width = 8, height = 6)
plot(group_plots[[1]])
plot(group_plots[[2]])
plot(group_plots[[3]])
plot(group_plots[[4]])
