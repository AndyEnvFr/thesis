...
# ggsave(paste0(root, "local/figures/ran/meanSR_slope_int.pdf"), plot1, width = 10, height = 6, dpi = 300)
# ggsave(paste0(root, "local/figures/ran/meanSR_slope_CV.pdf"), plot2, width = 10, height = 6, dpi = 300)
# ggsave(paste0(root, "local/figures/ran/meanSR_params.pdf"), combined_plot, width = 15, height = 10, dpi = 300)
```
