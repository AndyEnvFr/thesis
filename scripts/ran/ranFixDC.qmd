...
```{r}
tab <- readRDS(paste0(root, "/local/runs/mstr/20250903/ranTab_i.rds"))
```
...
saveRDS(dat_meta, paste0(root, "/local/runs/mstr/20250903/ranDatmeta_i.rds"))
saveRDS(metamod, paste0(root, "/local/runs/mstr/20250903/ranMetamod_i.rds"))
...
```{r}
datmeta <- readRDS(paste0(root, "/local/runs/mstr/20250903/ranDatmeta_i.rds"))
metamod <- readRDS(paste0(root, "/local/runs/mstr/20250903/ranMetamod_i.rds"))
...
```{r}
saveRDS(res, paste0(root, "/local/runs/mstr/20250903/ranRes_i.rds"))
```

#all results combined

```{r}
resi <- readRDS(paste0(root, "/local/runs/mstr/20250903/ranRes_i.rds"))
resii <- readRDS(paste0(root, "/local/runs/mstr/20250903/ranRes_ii.rds"))
resiii <- readRDS(paste0(root, "/local/runs/mstr/20250903/ranRes_iii.rds"))
...
pdf(paste0(root, "local/figures/ran/ran_all.pdf"), width = 10, height = 6.5, onefile = TRUE, useDingbats = FALSE)
    # Generate all plots for all scenarios with p-values
    plot_all_scenarios(scenario_dataP, scenario_labelsP, 
                       ylim_sr = c(40,100), ylim_abund = c(0,15000))
    plot_all_scenarios(scenario_dataN, scenario_labelsN, 
...
# Save plots if needed
ggsave(paste0(root, "local/figures/ran/meanSR_slope_int_all.pdf"), plot1, width = 10, height = 6, dpi = 300)
ggsave(paste0(root, "local/figures/ran/meanSR_slope_CV_all.pdf"), plot2, width = 10, height = 6, dpi = 300)
ggsave(paste0(root, "local/figures/ran/meanSR_params_all.pdf"), combined_plot, width = 15, height = 10, dpi = 300)
```
