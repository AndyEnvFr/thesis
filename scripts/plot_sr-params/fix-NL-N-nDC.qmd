...
```{r}
# saveRDS(runsRaw, paste0(root, "/local/runs/plot_sr-params/temp/fix-NL-N-nDC_con.rds"))
runsRaw  <- readRDS(paste0(root, "/local/runs/plot_sr-params/temp/fix-NL-N-nDC_con.rds"))
```
...
saveRDS(tab, paste0(root, "local/runs/plot_sr-params/tab/fix-N-NL-nDC.rds"))
```
...
saveRDS(dat_meta, paste0(root, "local/runs/plot_sr-params/metafor/fix-N-NL-nDC_datmeta.rds"))
saveRDS(metamod, paste0(root, "local/runs/plot_sr-params/metafor/fix-N-NL-nDC_metamod.rds"))
