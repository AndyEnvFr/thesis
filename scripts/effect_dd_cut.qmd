...
simu_0 <- runs[["dd0_disp1_sr2_e0_m1_cut1"]]$Output[[500]]$specMat
simu_05 <- runs[["dd0-5_disp1_sr2_e0_m1_cut1"]]$Output[[500]]$specMat
simu_1 <- runs[["dd1_disp1_sr2_e0_m1_cut1"]]$Output[[500]]$specMat
simu_15 <- runs[["dd1-5_disp1_sr2_e0_m1_cut1"]]$Output[[500]]$specMat
image(simu_0)
image(simu_05)
image(simu_1)
image(simu_15)
...
simu_0 <- runs[["dd0_disp1_sr2_e0_m1_cut5"]]$Output[[500]]$compMat
simu_05 <- runs[["dd0-5_disp1_sr2_e0_m1_cut5"]]$Output[[500]]$compMat
simu_1 <- runs[["dd1_disp1_sr2_e0_m1_cut5"]]$Output[[500]]$compMat
simu_15 <- runs[["dd1-5_disp1_sr2_e0_m1_cut5"]]$Output[[500]]$compMat
image(simu_0)
image(simu_05)
image(simu_1)
image(simu_15)
