...
runsRaw  <- readRDS(paste0(root, "/local/runs/mstr/20250807/runs_glmDcStruggle.rds"))
```
...
saveRDS(tab, paste0(root, "local/runs/mstr/20250807/tab_GlmDcStruggle.rds"))
```

We only keep important/varying parameters in the naming. Fixed params are excluded.

```{r}
tab <- readRDS(paste0(root, "local/runs/mstr/20250807/tab_ix.rds"))
```
...
saveRDS(dat_meta, paste0(root, "local/runs/mstr/20250807/dat_metaGlmDc.rds"))
saveRDS(metamod, paste0(root, "local/runs/mstr/20250807/metamoGlmDc.rds"))
