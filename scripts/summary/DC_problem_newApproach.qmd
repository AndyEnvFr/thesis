...
Here, I try a new approach: i deetect the max range of neighbors in the batch for each runs. Eventually, a nDC and pDC = 1 runs will be compared with 28 nieghbors, if in the same batch max DC = 3.
